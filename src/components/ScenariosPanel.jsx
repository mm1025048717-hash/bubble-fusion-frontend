...
const scenarios = [
  ...
  { id: 'case2', title: '落地 Demo｜上传文件→摘要→融合→方案→Agent 执行', bubbles: ['环保包装方案','年轻用户洞察','素材示例'], prompt: '把“环保包装方案”与“年轻用户洞察”融合，输出详细版结构 JSON，并带KPI与两周冲刺。', pair: [0,1], preset: { title: '环保包装方案 × 年轻用户洞察', notes: '一句话主张：环保也可以很潮流，不一定是单调的。\nBig Idea：回收即升级，线上线下闭环+社交传播。\n标题Top5：环保科技潮包装；环保也可以很酷炫；城市打卡计划；回收即升级；一图看懂。\n开场钩子Top5：先抛问题…；反差开场…；数字开场…；故事开场…；悬念开场…。\n传播链路：抖音/小红书/视频号/社群 联动种草与转化。\n素材清单：品牌主视觉、短视频脚本、海报KV、落地页、用户证言、FAQ、活动页。\nMVP：小范围样品收集反馈；KPI：转发率/兑换率/复购率。' }, attachments: [
    { bubbleIndex: 0, files: [ { name: '环保包装调研.txt', type: 'text/plain', textPreview: '调研摘要：材料替换、用户态度、价格弹性…' } ] },
    { bubbleIndex: 1, files: [ { name: 'Z世代洞察.txt', type: 'text/plain', textPreview: 'Z世代：悦己、社交炫耀、挑战机制偏好…' } ] }
  ], openDetailIndex: 0 },
